...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql = "INSERT INTO usuarios(Matricula, Nombre, Apaterno, Amaterno, Tipo, Status, Id_carrera, Id_semestre)
            VALUES('$matricula','$nombre','$apaterno','$amaterno','$tipo','$status', (SELECT Id_carrera FROM carrera WHERE Nombre = '$carrera'), (SELECT Id_semestre FROM semestre WHERE  N_semestre = '$semestre'))";
    ...
    if($conn->query($sql)==TRUE){
        ...
        //echo "<a href='modificaralumno.php?matricula=" .$matricula. "' >Modificar</a>";
    }
    else{
